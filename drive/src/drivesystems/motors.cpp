...
pros::Motor m_fly2(M_FLY2_PORT, FLY_GEARSET, false, pros::E_MOTOR_ENCODER_DEGREES);

pros::Motor m_push(M_PUSH_PORT, PUSH_GEARSET, false, pros::E_MOTOR_ENCODER_DEGREES);

pros::Motor m_intake(M_INTAKE_PORT, INTAKE_GEARSET, false, pros::E_MOTOR_ENCODER_ROTATIONS);
